...
@Transactional
public class AreasServicesImpl implements AreasService {
    ...
    @Override
    public List<Areas> findAreasByCitiesId(String citiesId) {
        try{
            List<Areas> areasList = areasMapper.findAreasByCitiesId(citiesId);
            return areasList;
        }catch (Exception e){
